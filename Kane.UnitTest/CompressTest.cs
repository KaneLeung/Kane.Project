...
namespace Kane.UnitTest
{
    ...
    public class CompressTest
    {
        ...
        public void Compress()
        {
            ...
            var deflateByte = compress.Compress(data.ToBytes(), CompressMethod.Deflate);
            var gzipByte = compress.Compress(data.ToBytes(), CompressMethod.GZip);
            var brotliByte = compress.Compress(data.ToBytes(), CompressMethod.Brotli);

            var deflateBase64 = compress.CompressToBase64(data, CompressMethod.Deflate);//deflateBase64.Length = 14064
            var gzipBase64 = compress.CompressToBase64(data, CompressMethod.GZip);//gzipBase64.Length = 14088
            var brotliBase64 = compress.CompressToBase64(data, CompressMethod.Brotli);//brotliBase64.Length = 11612

            var deflatDeCompressFormByte = compress.DeCompressFromByte(deflateByte, CompressMethod.Deflate);
            var gzipDeCompressFormByte = compress.DeCompressFromByte(gzipByte, CompressMethod.GZip);
            var brotliDeCompressFormByte = compress.DeCompressFromByte(brotliByte, CompressMethod.Brotli);

            var deflatDeCompressFormBase64 = compress.DeCompressFromBase64(deflateBase64, CompressMethod.Deflate);
            var gzipDeCompressFormBase64 = compress.DeCompressFromBase64(gzipBase64, CompressMethod.GZip);
            var brotliDeCompressFormBase64 = compress.DeCompressFromBase64(brotliBase64, CompressMethod.Brotli);
