...
namespace Kane.UnitTest
{
    ...
    public class CompressTest
    {
        ...
        public void Compress()
        {
            ...
            var deflateByte = CompressHelper.Compress(data.ToBytes(), CompressMethod.Deflate);
            var gzipByte = CompressHelper.Compress(data.ToBytes(), CompressMethod.GZip);
            var brotliByte = CompressHelper.Compress(data.ToBytes(), CompressMethod.Brotli);

            var deflateBase64 = CompressHelper.CompressToBase64(data, CompressMethod.Deflate);//deflateBase64.Length = 14064
            var gzipBase64 = CompressHelper.CompressToBase64(data, CompressMethod.GZip);//gzipBase64.Length = 14088
            var brotliBase64 = CompressHelper.CompressToBase64(data, CompressMethod.Brotli);//brotliBase64.Length = 11612

            var deflatDeCompressFormByte = CompressHelper.DeCompressFromByte(deflateByte, CompressMethod.Deflate);
            var gzipDeCompressFormByte = CompressHelper.DeCompressFromByte(gzipByte, CompressMethod.GZip);
            var brotliDeCompressFormByte = CompressHelper.DeCompressFromByte(brotliByte, CompressMethod.Brotli);

            var deflatDeCompressFormBase64 = CompressHelper.DeCompressFromBase64(deflateBase64, CompressMethod.Deflate);
            var gzipDeCompressFormBase64 = CompressHelper.DeCompressFromBase64(gzipBase64, CompressMethod.GZip);
            var brotliDeCompressFormBase64 = CompressHelper.DeCompressFromBase64(brotliBase64, CompressMethod.Brotli);
