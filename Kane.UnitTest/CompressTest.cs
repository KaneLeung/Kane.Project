...
* 作　　者 ：Kane Leung
* 创建时间 ：2019/12/4 23:08:29
* 更新时间 ：2019/12/4 23:08:29
* 版 本 号 ：v1.0.0.0
*******************************************************************
...
namespace Kane.UnitTest
{
    ...
    public class CompressTest
    {
        ...
        public void Compress()
        {
            ...
            var deflateByte = CompressHelper.Compress(data.ToBytes(), CompressHelper.CompressMethod.Deflate);
            var gzipByte = CompressHelper.Compress(data.ToBytes(), CompressHelper.CompressMethod.GZip);
            var brotliByte = CompressHelper.Compress(data.ToBytes(), CompressHelper.CompressMethod.Brotli);

            var deflateBase64 = CompressHelper.CompressToBase64(data, CompressHelper.CompressMethod.Deflate);//deflateBase64.Length = 14064
            var gzipBase64 = CompressHelper.CompressToBase64(data, CompressHelper.CompressMethod.GZip);//gzipBase64.Length = 14088
            var brotliBase64 = CompressHelper.CompressToBase64(data, CompressHelper.CompressMethod.Brotli);//brotliBase64.Length = 11612

            var deflatDeCompressFormByte = CompressHelper.DeCompressFromByte(deflateByte, CompressHelper.CompressMethod.Deflate);
            var gzipDeCompressFormByte = CompressHelper.DeCompressFromByte(gzipByte, CompressHelper.CompressMethod.GZip);
            var brotliDeCompressFormByte = CompressHelper.DeCompressFromByte(brotliByte, CompressHelper.CompressMethod.Brotli);

            var deflatDeCompressFormBase64 = CompressHelper.DeCompressFromBase64(deflateBase64, CompressHelper.CompressMethod.Deflate);
            var gzipDeCompressFormBase64 = CompressHelper.DeCompressFromBase64(gzipBase64, CompressHelper.CompressMethod.GZip);
            var brotliDeCompressFormBase64 = CompressHelper.DeCompressFromBase64(brotliBase64, CompressHelper.CompressMethod.Brotli);
